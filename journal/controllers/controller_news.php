<?php
	...
	{
		//Как только мы создадим экземпляр нашего класса произойдет вызов конструктора
		...
		function action_index()
		{
			...
			//Передаем полученные данные в представление и указываем имя файла шаблона и страницы
